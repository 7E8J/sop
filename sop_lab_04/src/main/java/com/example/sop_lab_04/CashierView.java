...
public class CashierView extends VerticalLayout{
    private final NumberField moneyField = new NumberField("เงินทอน");
    private final NumberField b1000Field = new NumberField();
    private final NumberField b500Field = new NumberField();
    private final NumberField b100Field = new NumberField();
    private final NumberField b20Field = new NumberField();
    private final NumberField b10Field = new NumberField();
    private final NumberField b5Field = new NumberField();
    private final NumberField b1Field = new NumberField();
    ...
    public CashierView() {
        ...
        add(moneyField);
        Button changeButton = new Button("คำนวณเงินทอน");
        add(changeButton);
        add(b1000Field);
        add(b500Field);
        add(b100Field);
